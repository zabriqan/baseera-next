  ...
  return (
    <div>
      ...
      <section id="about" className="w-full bg-white py-12 scroll-mt-24">
        <div className="md:w-7xl w-80 mx-auto flex flex-col md:flex-row gap-12 items-center ">
          <Image
            src={aboutImage}
            alt="About Us"
            className=" md:w-5/12 h-[200px] md:h-[500px] object-cover rounded-lg mx-auto"
          />
          <div className="max-w-[95%] mx-auto md:w-7/12 text-center md:text-left">
      ...
      <section className="w-full bg-white py-12 ">
        <div className="md:w-7xl w-80 mx-auto flex flex-col md:flex-row-reverse gap-12 items-center">
          <Image
            src={missionImage}
            alt="Mission"
            className="w-full md:w-5/12 h-[275px] md:h-[375px] object-cover rounded-lg mx-auto"
          />
      ...
      <section className="w-full bg-white py-12">
        <div className="md:w-7xl w-80 mx-auto flex flex-col md:flex-row gap-12 items-center ">
          <Image
            src={visionImage}
            alt="Vision"
            className="w-full md:w-5/12 h-[200px] md:h-[300px] object-cover rounded-lg mx-auto"
          />
